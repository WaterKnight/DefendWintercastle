...
//! runtextmacro BaseStruct("Order", "ORDER")
    ...
    //! runtextmacro CreateAnyFlagState("parallel", "Parallel")
...
//! runtextmacro Folder("OrderInstance")
...
//! runtextmacro BaseStruct("OrderInstance", "ORDER_INSTANCE")
    static thistype TEMP

    //! runtextmacro LinkToStruct("OrderInstance", "Refs")
    ...
    //! runtextmacro CreateAnyState("whichOrder", "Order", "Order")
