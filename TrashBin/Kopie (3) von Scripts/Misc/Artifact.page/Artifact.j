//! runtextmacro BaseStruct("Artifact", "ARTIFACT")
    ...
    static method Init takes nothing returns nothing
        local UnitType thisUnitType

        //! runtextmacro Unit_Create("/", "thisUnitType", "ArS", "Artifact Spot", "false", "OTHER", "1.")
        ...
        //! runtextmacro Unit_SetIcon("/", "ReplaceableTextures\\CommandButtons\\BTNCOP.blp")
        //! runtextmacro Unit_SetLife("/", "UNIT_TYPE.Life.BLACK_DISPLAY", "0.")
        //! runtextmacro Unit_SetMissilePoints("/", "120.", "0.", "0.", "60.")
        //! runtextmacro Unit_SetModel("/", "buildings\\other\\CircleOfPower\\CircleOfPower.mdx", "", "", "", "")
        //! runtextmacro Unit_SetScale("/", "1.5", "2.66")
        //! runtextmacro Unit_SetSight("/", "500.", "500.")
        //! runtextmacro Unit_SetSoundset("/", "CircleOfPower")
