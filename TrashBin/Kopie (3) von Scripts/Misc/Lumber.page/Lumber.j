//! runtextmacro BaseStruct("Lumber", "LUMBER")
    ...
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dLum", "Lumber", "DUMMY_UNIT_ID", "units\\nightelf\\Wisp\\Wisp.mdl")
    ...
    static method Event_Start takes nothing returns nothing
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1704), Rectangle.CreateFromSelf(gg_rct_Lumber))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1725), Rectangle.CreateFromSelf(gg_rct_Lumber2))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1724), Rectangle.CreateFromSelf(gg_rct_Lumber3))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1726), Rectangle.CreateFromSelf(gg_rct_Lumber4))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_0188), Rectangle.CreateFromSelf(gg_rct_Lumber5))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1731), Rectangle.CreateFromSelf(gg_rct_Lumber6))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1732), Rectangle.CreateFromSelf(gg_rct_Lumber7))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1734), Rectangle.CreateFromSelf(gg_rct_Lumber8))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1733), Rectangle.CreateFromSelf(gg_rct_Lumber9))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1730), Rectangle.CreateFromSelf(gg_rct_Lumber10))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1727), Rectangle.CreateFromSelf(gg_rct_Lumber11))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1729), Rectangle.CreateFromSelf(gg_rct_Lumber12))
        call thistype.Create(Destructable.GetFromSelf(gg_dest_B00H_1728), Rectangle.CreateFromSelf(gg_rct_Lumber13))
    endmethod

    static method Init takes nothing returns nothing
        //! runtextmacro Item_Create("/", "THIS_ITEM_TYPE", "Lum", "Lumber")

        //! runtextmacro Item_AddClass("/", "POWER_UP")
        //! runtextmacro Item_SetDescription("/", "Can be burnt to restore the meteorite's energy or be used to make some upgrades.")
        //! runtextmacro Item_SetModel("/", "Objects\\InventoryItems\\BundleofLumber\\BundleofLumber.mdl")
        //! runtextmacro Item_SetScale("/", "1.25")
