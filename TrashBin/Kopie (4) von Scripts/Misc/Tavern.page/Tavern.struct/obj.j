//open object D:\Warcraft III\Maps\DWC\Scripts\Misc\Tavern.page\Tavern.struct\obj_shop.j
static UnitType SHOP
    
    
static method Init_obj_shop takes nothing returns nothing
    local ObjThread t = ObjThread.Create("D:\\Warcraft III\\Maps\\DWC\\Scripts\\Misc\\Tavern.page\\Tavern.struct\\shop.wc3unit")
    set thistype.SHOP = UnitType.Create('uTav')
    ...
    call DebugEx("init " + "D:\\Warcraft III\\Maps\\DWC\\Scripts\\Misc\\Tavern.page\\Tavern.struct\\shop.wc3unit")
    call t.Destroy()
endmethod
//close object D:\Warcraft III\Maps\DWC\Scripts\Misc\Tavern.page\Tavern.struct\obj_shop.j
