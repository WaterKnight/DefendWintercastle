...
//! runtextmacro BaseStruct("CreepSet", "CREEP_SET")
    ...
    static method Init takes nothing returns nothing
        ...
        //Act1
            ...
            call this.AddCreep(Creep.Create(UnitType.BLUE_DRAGON_SPAWN, gg_unit_uBDS_0081))
            call this.AddCreep(Creep.Create(UnitType.BLUE_DRAGON_SPAWN, gg_unit_uBDS_0117))
            call this.AddCreep(Creep.Create(UnitType.TUSKAR, gg_unit_uTus_0099))
            call this.AddCreep(Creep.Create(UnitType.TUSKAR, gg_unit_uTus_0112))
            ...
            call this.AddCreep(Creep.Create(UnitType.FURBOLG_MOTHER, gg_unit_uFuM_0110))
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_BROWN, gg_unit_uKoM_0115))
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_BROWN, gg_unit_uKoM_0116))
            ...
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_BLUE, gg_unit_uKoB_0102))
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_BLUE, gg_unit_uKoB_0124))
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_RED, gg_unit_uKoR_0113))
            call this.AddCreep(Creep.Create(UnitType.KOBOLD_RED, gg_unit_uKoR_0114))
            call this.AttachToLevel(Level.GNOLLS)
            ...
            call this.AddCreep(Creep.Create(UnitType.PANDARENE, gg_unit_uPan_0079))
            call this.AddCreep(Creep.Create(UnitType.PANDARENE, gg_unit_uPan_0083))
            call this.AttachToLevel(Level.GNOLLS)
            ...
            call this.AddCreep(Creep.Create(UnitType.WOLF, gg_unit_uWol_0097))
            call this.AddCreep(Creep.Create(UnitType.WOLF, gg_unit_uWol_0123))
            call this.AddCreep(Creep.Create(UnitType.WOLF_MOTHER, gg_unit_uWoM_0122))
            call this.AttachToLevel(Level.GNOLLS)
        //Act2
    endmethod
endstruct