...
//! runtextmacro Folder("DefenderSpawnType")
    ...
    //! runtextmacro Struct("Event")
        //! runtextmacro CreateAnyStaticStateDefault("TRIGGER", "Trigger", "DefenderSpawnType", "NULL")
...
//! runtextmacro BaseStruct("DefenderSpawnGroup", "DEFENDER_SPAWN_GROUP")
    ...
    method Run takes nothing returns nothing
        ...
        local DefenderSpawnType whichType
        ...
        loop
            ...
            set whichType = this.Data.Integer.Table.Get(TYPES_KEY_ARRAY, iteration)
...
//! runtextmacro Folder("DefenderSpawnWave")
    ...
    //! runtextmacro Struct("Groups")
        ...
        method Run takes nothing returns nothing
            local DefenderSpawnGroup currentGroup
            local integer iteration = Memory.IntegerKeys.Table.STARTED
            ...
            loop
                ...
                set currentGroup = parent.Data.Integer.Table.Get(KEY_ARRAY, iteration)
...
//! runtextmacro BaseStruct("DefenderSpawnWave", "DEFENDER_SPAWN_WAVE")
    ...
    static method Init takes nothing returns nothing
        ...
        loop
            ...
            set currentLevel = Level.ALL[iteration]

            if (currentLevel.IsBonus() == false) then
                set this = thistype.CreateFromLevel(currentLevel)

                set currentGroup = DefenderSpawnGroup.Create(DefenderSpawnLocation.SOURCE_CENTER, DefenderSpawnLocation.TARGET_LEFT)
...
//! runtextmacro BaseStruct("DefenderSpawn", "DEFENDER_SPAWN")
    ...
    static method Add_TriggerEvents takes DefenderSpawnType whichType, Unit whichUnit returns nothing
        ...
        loop
            ...
            loop
                ...
                call DEFENDER_SPAWN_TYPE.Event.SetTrigger(whichType)
    ...
    static method Event_LevelStart takes nothing returns nothing
        local DefenderSpawnWave thisWave = DefenderSpawnWave.GetFromLevel(LEVEL.Event.GetTrigger())
