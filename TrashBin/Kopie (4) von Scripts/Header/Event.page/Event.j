...
//! runtextmacro BaseStruct("Event", "EVENT")
    ...
    static method CreateLimit takes string name, integer whichType, integer priority, integer value, limitop whichOperator, code actionFunction returns thistype
