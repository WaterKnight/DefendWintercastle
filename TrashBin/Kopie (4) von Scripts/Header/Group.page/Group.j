...
//! runtextmacro BaseStruct("Group", "GROUP")
    ...
    static method AddBuff_Enum takes nothing returns nothing
        call UNIT.Event.Native.GetEnum().Buffs.Timed.Start(ADD_BUFF_BUFF[thistype.ADD_BUFF_NESTING], ADD_BUFF_LEVEL[thistype.ADD_BUFF_NESTING], ADD_BUFF_DURATION[thistype.ADD_BUFF_NESTING])
    endmethod
