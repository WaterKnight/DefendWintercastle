//open object D:\Warcraft III\Maps\DWC\Scripts\Spells\Hero\RigorMortis.page\RigorMortis.struct\obj_dummyBuff.j
static Buff DUMMY_BUFF
    
    
static method Init_obj_dummyBuff takes nothing returns nothing
    local ObjThread t = ObjThread.Create("D:\\Warcraft III\\Maps\\DWC\\Scripts\\Spells\\Hero\\RigorMortis.page\\RigorMortis.struct\\dummyBuff.wc3buff")
    set thistype.DUMMY_BUFF = Buff.CreateHidden(thistype.NAME + " (dummyBuff)")
    call DebugEx("init " + "D:\\Warcraft III\\Maps\\DWC\\Scripts\\Spells\\Hero\\RigorMortis.page\\RigorMortis.struct\\dummyBuff.wc3buff")
    call t.Destroy()
endmethod
//close object D:\Warcraft III\Maps\DWC\Scripts\Spells\Hero\RigorMortis.page\RigorMortis.struct\obj_dummyBuff.j

//open object D:\Warcraft III\Maps\DWC\Scripts\Spells\Hero\RigorMortis.page\RigorMortis.struct\obj_thisSpell.j
...
static method Init_obj_thisSpell takes nothing returns nothing
    ...
    call t.Destroy()
endmethod
//close object D:\Warcraft III\Maps\DWC\Scripts\Spells\Hero\RigorMortis.page\RigorMortis.struct\obj_thisSpell.j
