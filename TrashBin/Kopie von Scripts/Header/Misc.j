...
//! runtextmacro Folder("DummyUnit")
    ...
    //! runtextmacro Folder("Position")
        ...
        //! runtextmacro Struct("Z")
            static constant integer ENABLER_SPELL_ID = 'Amrf'
            ...
            method Event_Create takes real x, real y, real z returns nothing
                call DummyUnit(this).Abilities.AddBySelf(thistype.ENABLER_SPELL_ID)
                call DummyUnit(this).Abilities.RemoveBySelf(thistype.ENABLER_SPELL_ID)
...
//! runtextmacro BaseStruct("DummyUnit", "DUMMY_UNIT")
    ...
    //! textmacro DummyUnit_CreateSimpleType takes doExternal, unitRaw, objectName, varName, modelPath
        static constant integer $varName$ = '$unitRaw$'
        ...
        $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
            ...
            //! i set("uine", "\0")
            //! i set("ulpz", 0)
            //! i set("umdl", "$modelPath$")
            //! i set("umvs", -1)
            //! i set("umvt", "")
            //! i set("umxr", 0)
            //! i set("umxp", 0)
            //! i set("unam", "$objectName$")
            //! i set("upgr", "")
            //! i set("upoi", 0)
            //! i set("uprw", 0)
            //! i set("urac", "other")
    ...
    //! runtextmacro DummyUnit_CreateSimpleType("", "DWoC", "World Caster", "WORLD_CASTER_ID", "")
    ...
    method SetLocust takes nothing returns nothing
        call UnitAddAbility(this.self, 'Aloc')
    endmethod
