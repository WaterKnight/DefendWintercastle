...
//! runtextmacro Folder("SpawnType")
    ...
    //! runtextmacro Struct("Champion")
        ...
        static method Event_Spawn takes nothing returns nothing
            ...
            call whichUnit.Abilities.Add(Spell.METEORITE_PROTECTION)
...
//! runtextmacro BaseStruct("SpawnType", "SPAWN_TYPE")
    ...
    static method Finalize takes nothing returns nothing
        ...
        loop
            ...
            if (this.IsBoss()) then
                call whichUnitType.Abilities.Add(Spell.METEORITE_PROTECTION)
            endif
    ...
    static method Init takes nothing returns nothing
        ...
        //Bonus
            //Flying Penguin
            set this = thistype.Create(UnitType.FLYING_PENGUIN_BONUS)

            set thistype.FLYING_PENGUIN = this
            call this.SetRanged(true)

            //Penguin
            set this = thistype.Create(UnitType.PENGUIN_BONUS)

            set thistype.PENGUIN = this
            call this.SetMelee(true)

            //Penguin Champ
            set this = thistype.Create(UnitType.PENGUIN_CHAMP_BONUS)
...
//! runtextmacro BaseStruct("SpawnWave", "SPAWN_WAVE")
    ...
    static method Init takes nothing returns nothing
        ...
        //Act2
            ...
            call this.Type.SetIntervalsAmountByParent(thisTypeIndex, thistype(NULL).Type.STANDARD_INTERVALS_AMOUNT / 2)
