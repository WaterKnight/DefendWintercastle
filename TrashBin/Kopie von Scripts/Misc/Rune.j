//! runtextmacro BaseStruct("Rune", "RUNE")
    static constant string AREA_EFFECT_PATH = "Abilities\\Spells\\Other\\Andt\\Andt.mdl"
    static constant real AREA_RANGE = 200.
    static constant real DURATION = 20.
    static Group ENUM_GROUP
    static constant real HEAL_LIFE_RELATIVE_AMOUNT = 0.15
    static constant real HEAL_MANA_RELATIVE_AMOUNT = 0.15
    //! runtextmacro GetKey("KEY")
    static Event RUNE_DEATH_EVENT
    static integer SPAWN_AMOUNT = ARRAY_MIN
    static constant integer SPAWN_AMOUNT_FOR_RUNE = 12
    ...
    static method Event_Spawn_Death takes nothing returns nothing
        ...
        set rune = Item.Create(ItemType.RUNE, whichUnit.Position.X.Get(), whichUnit.Position.Y.Get())
    ...
    static method Init takes nothing returns nothing
        ...
        call ItemType.RUNE.Event.Add(Event.Create(UNIT.Items.Events.Use.DUMMY_EVENT_TYPE, EventPriority.MISC, function thistype.Event_ItemUse))
    endmethod
endstruct