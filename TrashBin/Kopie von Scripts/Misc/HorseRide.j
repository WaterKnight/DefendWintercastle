//! runtextmacro Folder("HorseRide")
    //! runtextmacro Struct("Target")
        static constant real DISMOUNT_OFFSET = 200.
        static Buff DUMMY_BUFF
        static constant real DUMMY_UNIT_DURATION = 0.5
        static constant real DUMMY_UNIT_OFFSET = -65.
        static constant string ENDING_EFFECT_ATTACH_POINT = AttachPoint.ORIGIN
        static constant string ENDING_EFFECT_PATH = "Abilities\\Spells\\Human\\Polymorph\\PolyMorphDoneGround.mdl"
        static constant real FADE_OUT = 2.
        static constant string HORSE_EFFECT_ATTACH_POINT = AttachPoint.ORIGIN
        static constant string HORSE_EFFECT_PATH = "UI\\Feedback\\WaypointFlags\\WaypointFlag.mdl"
        //! runtextmacro DummyUnit_CreateSimpleType("/", "dHoR", "Horse Ride", "HORSE_ID", "Units\\Human\\KnightNoRider\\KnightNoRider.mdl")
        static constant string START_EFFECT_ATTACH_POINT = AttachPoint.ORIGIN
        static constant string START_EFFECT_PATH = "Abilities\\Spells\\Human\\Polymorph\\PolyMorphDoneGround.mdl"
...
//! runtextmacro BaseStruct("HorseRide", "HORSE_RIDE")
    ...
    static method Init takes nothing returns nothing
        ...
        call ItemType.HORSE_RIDE.Event.Add(Event.Create(UNIT.Items.Events.Sell.DUMMY_EVENT_TYPE, EventPriority.ITEMS, function thistype.Event_Sell))
