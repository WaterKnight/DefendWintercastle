...
//! runtextmacro Folder("Lapidation")
    //! runtextmacro Struct("Buff")
        ...
        static method Init takes nothing returns nothing
            //! import obj_Lapidation_Buff.j

                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "Lap", "Lapidated", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNGolemStormBolt.blp", "This unit is stunned by 'Lapidation'.")
...
//! runtextmacro BaseStruct("Lapidation", "LAPIDATION")
    static real DAMAGE
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dLap", "Lapidation", "DUMMY_UNIT_ID", "Abilities\\Weapons\\RockBoltMissile\\RockBoltMissile.mdl")
    static Group ENUM_GROUP
    static integer MAX_TARGETS_AMOUNT
