...
//! runtextmacro Folder("Barrier")
    //! runtextmacro Struct("Knockback")
        ...
        static method Init takes nothing returns nothing
            //! import obj_Barrier_Knockback.j
...
//! runtextmacro BaseStruct("Barrier", "BARRIER")
    static string BARRIER_EFFECT_ATTACH_POINT
    static string BARRIER_EFFECT_PATH
    static real CASTER_OFFSET
    static Buff DUMMY_BUFF
    ...
    static method Init takes nothing returns nothing
        //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "Bar", "Strong", "5", "true", "ReplaceableTextures\\CommandButtons\\BTNFrostMourne.blp", "Very strong")

        //! import obj_Barrier.j
