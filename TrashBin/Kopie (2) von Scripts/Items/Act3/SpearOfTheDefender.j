//! runtextmacro Folder("SpearOfTheDefender")
    //! runtextmacro Struct("Buff")
        ...
        static method Init takes nothing returns nothing
            //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "SoD", "Bleeding", "1", "true", "", "This unit was perforated by 'Spear of the Defender', it loses hitpoints over time.")
...
//! runtextmacro BaseStruct("SpearOfTheDefender", "SPEAR_OF_THE_DEFENDER")
    ...
    static method Init takes nothing returns nothing
        ...
        call ItemType.SPEAR_OF_THE_DEFENDER.Event.Add(Event.Create(UNIT.Items.Events.Lose.DUMMY_EVENT_TYPE, EventPriority.ITEMS, function thistype.Event_Drop))
        call ItemType.SPEAR_OF_THE_DEFENDER.Event.Add(Event.Create(UNIT.Items.Events.Gain.DUMMY_EVENT_TYPE, EventPriority.ITEMS, function thistype.Event_PickUp))
