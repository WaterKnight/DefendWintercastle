//! runtextmacro BaseStruct("RabbitsFoot", "RABBITS_FOOT")
    ...
    static method Init takes nothing returns nothing
        call ItemType.RABBITS_FOOT.Event.Add(Event.Create(UNIT.Items.Events.Lose.DUMMY_EVENT_TYPE, EventPriority.ITEMS, function thistype.Event_Drop))
        call ItemType.RABBITS_FOOT.Event.Add(Event.Create(UNIT.Items.Events.Gain.DUMMY_EVENT_TYPE, EventPriority.ITEMS, function thistype.Event_PickUp))
    endmethod
endstruct