//! runtextmacro Folder("EnergyCharge")
    //! runtextmacro Struct("Target")
        ...
        static real DAMAGE_INCREMENT
        static Buff DUMMY_BUFF
        static real HEAL

        //! import "Spells\Act1\EnergyCharge_Target\obj.j"
        ...
        static method Init takes nothing returns nothing
            set thistype.DAMAGE_EVENT = Event.Create(UNIT.Damage.Events.ATTACKER_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_Damage)
                ...
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "EnC", "Energy Charge", "1", "true", "ReplaceableTextures\\CommandButtons\\BTNSeaGiantPulverize.blp", "The next attack deals extra damage and restores some life.")
...
//! runtextmacro BaseStruct("EnergyCharge", "ENERGY_CHARGE")
    static integer ATTACKS_AMOUNT_NEEDED
    static Event DAMAGE_EVENT
    static Buff DUMMY_BUFF

    static Spell THIS_SPELL

    //! import "Spells\Act1\EnergyCharge\obj.j"
