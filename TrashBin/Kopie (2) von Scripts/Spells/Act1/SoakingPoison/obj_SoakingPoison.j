...
static method Init_obj_SoakingPoison takes nothing returns nothing
    set SpellObjectCreation.TEMP = Spell.CreateFromSelf('ASoP')
    
    call SpellObjectCreation.TEMP.SetClass(SpellClass.NORMAL)
    call SpellObjectCreation.TEMP.SetLevelsAmount(1)
    call SpellObjectCreation.TEMP.SetName("Soaking Poison")
    ...
    call SpellObjectCreation.TEMP.SetIcon("ReplaceableTextures\\PassiveButtons\\PASBTNPoisonSting.blp")
