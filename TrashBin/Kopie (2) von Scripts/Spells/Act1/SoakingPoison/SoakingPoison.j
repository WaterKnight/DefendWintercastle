//! runtextmacro Folder("SoakingPoison")
    //! runtextmacro Struct("Target")
        ...
        //! import "Spells\Act1\SoakingPoison\Target\obj.j"
        ...
        static method Init takes nothing returns nothing
            set thistype.DAMAGE = thistype.DAMAGE_PER_SECOND * thistype.INTERVAL
                ...
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "SoP", "Poisoned", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNPoisonSting.blp", "This unit suffers from a poison, its movements are slowed and the toxin prevents regeneration.")
...
//! runtextmacro BaseStruct("SoakingPoison", "SOAKING_POISON")
    ...
    //! import "Spells\Act1\SoakingPoison\obj.j"
