//! runtextmacro BaseStruct("ChaosBall", "CHAOS_BALL")
    ...
    static real DAMAGE
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dCha", "ChaosBall", "DUMMY_UNIT_ID", "Abilities\\Weapons\\DemonHunterMissile\\DemonHunterMissile.mdl")
    static real DURATION
    static Group ENUM_GROUP
    //! runtextmacro GetKey("KEY")
    static real OFFSET_Z
    static real RANGE_TOLERANCE
    static string SPECIAL_EFFECT_PATH
    static BoolExpr TARGET_FILTER

    static Spell THIS_SPELL

    //! import "Spells\Act1\ChaosBall\obj.j"
