//! runtextmacro BaseStruct("HealExplosion", "HEAL_EXPLOSION")
    static string CHARGE_EFFECT_ATTACH_POINT
    static string CHARGE_EFFECT_PATH
    static real DAMAGE
    ...
    static string EXPLOSION_EFFECT_ATTACH_POINT
    ...
    //! import "Spells\Act1\HealExplosion\obj.j"
