...
//! runtextmacro Folder("VividMeteor")
    //! runtextmacro Struct("Effects")
        ...
        static method Init takes nothing returns nothing
            //! import obj_VividMeteor_Effects.j
