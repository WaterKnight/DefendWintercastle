//! runtextmacro BaseStruct("TeleportScroll", "TELEPORT_SCROLL")
    static string CASTER_ARRIVAL_EFFECT_ATTACH_POINT
    static string CASTER_ARRIVAL_EFFECT_PATH
    static real DELAY
    static Buff DUMMY_BUFF
    static Group ENUM_GROUP
    //! runtextmacro GetKeyArray("KEY_ARRAY")
    static real MAX_OFFSET
    ...
    //! import "Spells\Items\Act1\TeleportScroll\obj.j"
