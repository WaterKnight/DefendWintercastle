//! runtextmacro Folder("HopNDrop")
    //! runtextmacro Folder("SetMines")
        //! runtextmacro Struct("Mine")
            ...
            static real EXPLOSION_DELAY
            static real FRIENDLY_FIRE_FACTOR
            //! runtextmacro GetKey("KEY")
            static real MOVE_DURATION
            static real MOVE_Z_SPEED_START
            static string SPECIAL_EFFECT_PATH
            static real STUN_DURATION
            static UnitType SUMMON_UNIT_TYPE
            static BoolExpr TARGET_FILTER

            //! import "Spells\Hero\HopNDrop\SetMines\Mine\obj.j"
            ...
            static method Init takes nothing returns nothing
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "SMB", "Mine", "5", "true", "ReplaceableTextures\\CommandButtons\\BTNGoblinLandMine.blp", "Goes boom.")
    ...
    //! runtextmacro Struct("SetMines")
        ...
        //! import "Spells\Hero\HopNDrop\SetMines\obj.j"
...
//! runtextmacro BaseStruct("HopNDrop", "HOP_N_DROP")
    ...
    //! import "Spells\Hero\HopNDrop\obj.j"
