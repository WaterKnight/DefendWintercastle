//! runtextmacro Folder("ManaLaser")
    //! runtextmacro Struct("Revert")
        static string CAST_EFFECT_PATH
        static string CAST_END_EFFECT_PATH
        static Buff DUMMY_BUFF
        static real DURATION
        static string SOURCE_EFFECT_PATH
        static real X
        static real Y

        static Spell THIS_SPELL

        //! import "Spells\Hero\ManaLaser\Revert\obj.j"
...
//! runtextmacro BaseStruct("ManaLaser", "MANA_LASER")
    static real array BURNED_MANA_MAX
    ...
    //! import "Spells\Hero\ManaLaser\obj.j"
