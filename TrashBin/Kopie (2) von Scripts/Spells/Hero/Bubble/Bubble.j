    ...
    //! runtextmacro Struct("Target")
        ...
        static method Init takes nothing returns nothing
            set thistype.DEATH_EVENT = Event.Create(UNIT.Death.Events.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_Death)
                ...
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "Bub", "Protected by a bubble", "3", "false", "ReplaceableTextures\\CommandButtons\\BTNBigBadVoodooSpell.blp", "This unit is protected from most harm.")
...
//! runtextmacro BaseStruct("Bubble", "BUBBLE")
    ...
    //! import "Spells\Hero\Bubble\obj.j"
    ...
    static method Init takes nothing returns nothing
        ...
        call thistype.THIS_SPELL.Event.Add(Event.Create(UNIT.Abilities.Events.Effect.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_SpellEffect))
            ...
            //call thistype.DUMMY_BUFF.TargetEffects.Add("Abilities\\Spells\\Undead\\Unsummon\\UnsummonTarget.mdl", AttachPoint.CHEST_MOUNT_LEFT, EffectLevel.NORMAL)
            //call thistype.DUMMY_BUFF.TargetEffects.Add("Abilities\\Spells\\Undead\\Unsummon\\UnsummonTarget.mdl", AttachPoint.CHEST_MOUNT_RIGHT, EffectLevel.NORMAL)
