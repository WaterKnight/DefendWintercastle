//! runtextmacro Folder("Tsukuyomi")
    //! runtextmacro Struct("Missile")
        //! runtextmacro DummyUnit_CreateSimpleType("/", "dTsM", "TsukuyomiMissile", "DUMMY_UNIT_ID", "Abilities\\Weapons\\GreenDragonMissile\\GreenDragonMissile.mdl")
    ...
    //! runtextmacro Struct("Relocate")
        ...
        //! import "obj_Tsukuyomi_Relocate.j"
    ...
    //! runtextmacro Struct("Target")
        ...
        //! import "Spells\Hero\Tsukuyomi\Target\obj.j"
...
//! runtextmacro BaseStruct("Tsukuyomi", "TSUKUYOMI")
    ...
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dTsu", "Tsukuyomi", "DUMMY_UNIT_ID", "Abilities\\Spells\\Undead\\VampiricAura\\VampiricAura.mdl")
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dTs2", "Tsukuyomi", "DUMMY_UNIT2_ID", "Abilities\\Spells\\Undead\\Possession\\PossessionTarget.mdl")
    static real array DURATION
    static Group ENUM_GROUP
    static Group ENUM_GROUP2
    static real INTERVAL
    //! runtextmacro DummyUnit_CreateSimpleType("", "dTsP", "Tsukuyomi Mover", "MOVING_DUMMY_UNIT_ID", "")
    static real array PULL_FACTOR
    static real array STOLEN_MANA
    static real STOLEN_MANA_ABSORPTION_FACTOR
    ...
    //! import "Spells\Hero\Tsukuyomi\obj.j"
