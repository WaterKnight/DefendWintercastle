//! runtextmacro Folder("DeprivingShock")
    //! runtextmacro Struct("Buff")
        ...
        //! import "Spells\Hero\DeprivingShock\Buff\obj.j"
        ...
        static method Init takes nothing returns nothing
            ...
            call DeprivingShock.THIS_SPELL.Event.Add(Event.Create(UNIT.Abilities.Events.Learn.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_Learn))
                ...
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF[1]", "DeS", "Depriving Shock", "5", "true", "ReplaceableTextures\\CommandButtons\\BTNRavenForm.blp", "Swift movements grant this unit an increased evasion chance.")
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF[2]", "De2", "Depriving Shock", "5", "true", "Spells\\DeprivingShock\\BTNBuff2.blp", "Swift movements grant this unit an increased evasion chance.")
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF[3]", "De3", "Depriving Shock", "5", "true", "Spells\\DeprivingShock\\BTNBuff3.blp", "Swift movements grant this unit an increased evasion chance.")
                ...
                loop
                    ...
                    call currentBuff.SetLostOnDispel(true)
                    call currentBuff.TargetEffects.Add("Abilities\\Spells\\Other\\Tornado\\Tornado_Target.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
                    call currentBuff.TargetEffects.Add("Abilities\\Spells\\Other\\Tornado\\Tornado_Target.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
                    call currentBuff.TargetEffects.Add("Abilities\\Spells\\Other\\Tornado\\Tornado_Target.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
                    call currentBuff.TargetEffects.Add("Abilities\\Spells\\Other\\Tornado\\Tornado_Target.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
...
//! runtextmacro BaseStruct("DeprivingShock", "DEPRIVING_SHOCK")
    static real array BURNED_MANA
    static real array DAMAGE
    static real array DAMAGE_FACTOR
    static real array DAMAGE_SPLASH
    ...
    static real TRANSFERED_MANA_FACTOR

    static Spell THIS_SPELL

    //! import "Spells\Hero\DeprivingShock\obj.j"
