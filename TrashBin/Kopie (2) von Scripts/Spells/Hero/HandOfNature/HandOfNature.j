//! runtextmacro Folder("HandOfNature")
    //! runtextmacro Struct("Buff")
        ...
        //! import "Spells\Hero\HandOfNature\Buff\obj.j"
        ...
        static method Init takes nothing returns nothing
            ...
            loop
                set thistype.DAMAGE[iteration] = thistype.DAMAGE[iteration] * thistype.INTERVAL / thistype.DURATION[iteration]

                set iteration = iteration - 1
                exitwhen (iteration < 1)
            endloop

                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "HoN", "Hand of Nature", "5", "false", "ReplaceableTextures\\CommandButtons\\BTNEntanglingRoots.blp", "This unit is stunned by 'Hand of Nature', has problems to evade attacks and takes damage over time.")
    ...
    //! runtextmacro Struct("Heal")
        ...
        static Buff DUMMY_BUFF
        static real array LIFE_HEAL
        static real array MANA_HEAL

        //! import "Spells\Hero\HandOfNature\Heal\obj.j"
...
//! runtextmacro BaseStruct("HandOfNature", "HAND_OF_NATURE")
    ...
    //! import "Spells\Hero\HandOfNature\obj.j"
    ...
    static method Event_SpellEffect takes nothing returns nothing
        ...
        set caster = Unit.CreateSummon(thistype.SUMMON_UNIT_TYPES[level], caster.Owner.Get(), targetX, targetY, UNIT.Facing.STANDARD, thistype.DURATION[level])

        call caster.Scale.Set(0.)
        call caster.Scale.Timed.Add(thistype.SUMMON_UNIT_TYPES[level].Scale.Get(), 1.)
