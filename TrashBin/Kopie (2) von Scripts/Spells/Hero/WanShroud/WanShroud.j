//! runtextmacro Folder("WanShroud")
    //! runtextmacro Struct("Missile")
        //! runtextmacro DummyUnit_CreateSimpleType("/", "dWSM", "WanShroudMissile", "DUMMY_UNIT_ID", "Abilities\\Weapons\\BrewmasterMissile\\BrewmasterMissile.mdl")
    ...
    //! runtextmacro Struct("Target")
        ...
        static real array MISS_INCREMENT

        //! import "Spells\Hero\WanShroud\Target\obj.j"
        ...
        static method Init takes nothing returns nothing
            set thistype.DEATH_EVENT = Event.Create(UNIT.Death.Events.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_Death)
                ...
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "WSh", "Wan Shroud", "5", "false", "ReplaceableTextures\\CommandButtons\\BTNCyclone.blp", "This unit's vision is restricted. Its sight range is reduced and attacks are likely to miss. Shrouded units take damage in intervals. Additionally, their armor is reduced.")
...
//! runtextmacro BaseStruct("WanShroud", "WAN_SHROUD")
    ...
    //! runtextmacro DummyUnit_CreateSimpleType("/", "dWSh", "WanShroud", "AREA_DUMMY_UNIT_ID", "Spells\\WanShroud\\Area.mdx")
    ...
    //! import "Spells\Hero\WanShroud\obj.j"
