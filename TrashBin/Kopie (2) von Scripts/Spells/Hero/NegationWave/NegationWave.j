//! runtextmacro BaseStruct("NegationWave", "NEGATION_WAVE")
    ...
    static string SPELL_STEAL_CASTER_EFFECT_ATTACH_POINT
    static string SPELL_STEAL_CASTER_EFFECT_PATH
    static string SPELL_STEAL_TARGET_EFFECT_ATTACH_POINT
    static string SPELL_STEAL_TARGET_EFFECT_PATH
    ...
    //! import "Spells\Hero\NegationWave\obj.j"
