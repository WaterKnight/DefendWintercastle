...
static method Init_obj_EnvenomedSpears takes nothing returns nothing
    set SpellObjectCreation.TEMP = Spell.CreateFromSelf('AEnS')
    
    call SpellObjectCreation.TEMP.SetClass(SpellClass.NORMAL)
    call SpellObjectCreation.TEMP.SetLevelsAmount(1)
    call SpellObjectCreation.TEMP.SetName("Envenomed Spears")
    ...
    call SpellObjectCreation.TEMP.SetIcon("ReplaceableTextures\\PassiveButtons\\PASBTNEnvenomedSpear.blp")
