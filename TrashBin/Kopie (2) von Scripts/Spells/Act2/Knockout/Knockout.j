//! runtextmacro Folder("Knockout")
    //! runtextmacro Struct("Target")
        ...
        //! import "Spells\Act2\Knockout\Target\obj.j"
        ...
        static method Init takes nothing returns nothing
                //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "KnO", "Knockout", "1", "true", "ReplaceableTextures\\CommandButtons\\BTNEntanglingRoots.blp", "This unit was recently paralyzed by a 'Knockout'; it cannot be stunned again by this spell while this buff persists.")
...
//! runtextmacro BaseStruct("Knockout", "KNOCKOUT")
    ...
    //! import "Spells\Act2\Knockout\obj.j"
