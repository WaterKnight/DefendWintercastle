//! runtextmacro BaseStruct("SummonMinions", "SUMMON_MINIONS")
    ...
    static real OFFSET
    static real SUMMON_DURATION
    static UnitType SUMMON_UNIT_TYPE
    static real SUMMON_UNIT_TYPE_CHANCE
    static UnitType SUMMON_UNIT_TYPE2
    static real SUMMON_UNIT_TYPE2_CHANCE
    static UnitTypePool SUMMON_UNIT_TYPE_POOL
    static integer SUMMONS_AMOUNT_PER_INTERVAL

    static Spell THIS_SPELL

    //! import "Spells\Act2\SummonMinions\obj.j"
