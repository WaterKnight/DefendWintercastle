//! runtextmacro BaseStruct("GoldCoin", "GOLD_COIN")
    ...
    static method Event_Spawn_Death takes nothing returns nothing
        ...
        set thisItem = Item.Create(ItemType.GOLD_COIN, whichUnit.Position.X.Get(), whichUnit.Position.Y.Get())
    ...
    static method Init takes nothing returns nothing
        ...
        call ItemType.GOLD_COIN.Event.Add(Event.Create(UNIT.Items.Events.Use.DUMMY_EVENT_TYPE, EventPriority.MISC, function thistype.Event_ItemUse))
    endmethod
endstruct