...
//! runtextmacro BaseStruct("HeroRevival", "HERO_REVIVAL")
    static constant string DEATH_EFFECT_ATTACH_POINT = AttachPoint.CHEST
    static constant string DEATH_EFFECT_PATH = "Abilities\\Spells\\Undead\\CarrionSwarm\\CarrionSwarmDamage.mdl"
    static Event DEATH_EVENT
    static CineFilter DUMMY_CINE_FILTER
    static constant string GHOST_EFFECT_ATTACH_POINT = AttachPoint.ORIGIN
    static constant string GHOST_EFFECT_PATH = "Abilities\\Spells\\Undead\\RegenerationAura\\ObsidianRegenAura.mdl"
    static boolean IGNORE_NEXT = false
    //! runtextmacro GetKey("KEY")
    static constant real LIFE_FACTOR = 0.5
    static constant real MAGIC_IMMUNITY_DURATION = 5.
    static constant integer MANA_CAP = 100
    static constant real MANA_FACTOR = 0.5
    static constant real MANA_REGENERATION = 10.
    static Rectangle array REVIVAL_RECTS
    static constant string REVIVE_EFFECT_ATTACH_POINT = AttachPoint.ORIGIN
    static constant string REVIVE_EFFECT_PATH = "Abilities\\Spells\\Human\\ReviveHuman\\ReviveHuman.mdl"
    ...
    static method Event_SpellEffect takes nothing returns nothing
        ...
        call whichUnit.Effects.Create(thistype.REVIVE_EFFECT_PATH, thistype.REVIVE_EFFECT_ATTACH_POINT, EffectLevel.NORMAL).DestroyTimed.Start(5.)
    ...
    static method Event_Death takes nothing returns nothing
        ...
        set this.ghostEffect = ghost.Effects.Create(thistype.GHOST_EFFECT_PATH, thistype.GHOST_EFFECT_ATTACH_POINT, EffectLevel.LOW)
        ...
        call ghost.Effects.Create(thistype.DEATH_EFFECT_PATH, thistype.DEATH_EFFECT_ATTACH_POINT, EffectLevel.NORMAL).DestroyTimed.Start(5.)
    ...
    static method Init takes nothing returns nothing
        ...
        //! runtextmacro Spell_Create("/", "THIS_SPELL", "AHRv", "Revive Hero")

        //! runtextmacro Spell_SetTypes("/", "NORMAL", "NORMAL")

        //! runtextmacro Spell_SetAnimation("/", "spell")
        //! runtextmacro Spell_SetCastTime("/", "1.")
        //! runtextmacro Spell_SetIcon("/", "ReplaceableTextures\\CommandButtons\\BTNResurrection.blp")
        //! runtextmacro Spell_SetManaCost("/", "100")
        //! runtextmacro Spell_SetOrder("/", "resurrection")
        //! runtextmacro Spell_SetTargetType("/", "IMMEDIATE")
        //! runtextmacro Spell_SetUberTooltip("/", "Revives the hero.")
