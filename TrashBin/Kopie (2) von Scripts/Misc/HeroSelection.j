//! runtextmacro BaseStruct("HeroSelection", "HERO_SELECTION")
    ...
    static method StairwayTrig takes nothing returns nothing
        ...
        call whichUnit.Items.Create(ItemType.MEAT, true)
        ...
        call whichUnit.Items.Create(ItemType.ICE_TEA, true)
...
//! runtextmacro BaseStruct("BasementStairwayUp", "BASEMENT_STAIRWAY_UP")
