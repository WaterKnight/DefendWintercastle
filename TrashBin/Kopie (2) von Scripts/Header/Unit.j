//! runtextmacro Folder("BJUnit")
    //! textmacro BJUnit_CreateStateWithPermanentAbilities takes decreasingMax, increasingMax
        static integer array DECREASING_SPELLS_ID
        static constant integer DECREASING_SPELLS_MAX = $decreasingMax$
        static integer array INCREASING_SPELLS_ID
        static constant integer INCREASING_SPELLS_MAX = $increasingMax$
    ...
    //! runtextmacro Folder("Armor")
        //! runtextmacro Struct("Bonus")
            //! textmacro BJUnit_Armor_Bonus_CreateObjects takes doExternal, up, index
                static if $up$ then
                    set thistype.INCREASING_SPELLS_ID[$index$] = 'Aia$index$'
                else
                    set thistype.DECREASING_SPELLS_ID[$index$] = 'Ada$index$'
                endif
                set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                ...
                $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                    ...
                    //! i if $up$ then
                        //! i createobject("AId1", "Aia$index$")

                        //! i set("anam", "Increase Armor")
                        //! i setl("Idef", 1, math.pow(2, $index$))
                    //! i else
                        //! i createobject("AId1", "Ada$index$")

                        //! i set("anam", "Decrease Armor")
                        //! i setl("Idef", 1, -math.pow(2, $index$))
                    //! i end
                ...
                static if $up$ then
                    call InitAbility('Aia$index$')
                else
                    call InitAbility('Ada$index$')
                endif
            //! endtextmacro

            //! runtextmacro BJUnit_CreateStateWithPermanentAbilities("6", "6")

            static method Init takes nothing returns nothing
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "0")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "1")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "2")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "3")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "4")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "5")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "false", "6")

                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "0")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "1")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "2")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "3")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "4")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "5")
                //! runtextmacro BJUnit_Armor_Bonus_CreateObjects("/", "true", "6")
            endmethod
        endstruct
    endscope
    ...
    //! runtextmacro Folder("Attack")
        //! runtextmacro Folder("Speed")
            //! runtextmacro Struct("BonusA")
                //! textmacro BJUnit_Attack_Speed_Bonus_CreateObjects takes doExternal, up, index
                    static if $up$ then
                        set thistype.INCREASING_SPELLS_ID[$index$] = 'AiR$index$'
                    else
                        set thistype.DECREASING_SPELLS_ID[$index$] = 'AdR$index$'
                    endif
                    set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i if $up$ then
                            //! i createobject("AIsx", "AiR$index$")

                            //! i set("anam", "Increase Attack Speed")
                            //! i setl("Isx1", 1, math.pow(2, $index$) / 100)
                        //! i else
                            //! i createobject("AIsx", "AdR$index$")

                            //! i set("anam", "Decrease Attack Speed")
                            //! i setl("Isx1", 1, -math.pow(2, $index$) / 100)
                        //! i end
                    ...
                    static if $up$ then
                        call InitAbility('AiR$index$')
                    else
                        call InitAbility('AdR$index$')
                    endif
                //! endtextmacro

                //! runtextmacro BJUnit_CreateStateWithPermanentAbilities("9", "9")

                static method Init takes nothing returns nothing
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "0")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "1")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "2")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "3")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "4")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "5")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "6")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "7")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "8")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "false", "9")

                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "0")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "1")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "2")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "3")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "4")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "5")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "6")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "7")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "8")
                    //! runtextmacro BJUnit_Attack_Speed_Bonus_CreateObjects("/", "true", "9")
                endmethod
            endstruct
        endscope
    ...
    //! runtextmacro Folder("Damage")
        //! runtextmacro Struct("Bonus")
            //! textmacro BJUnit_Damage_Bonus_CreateObjects takes doExternal, up, index
                set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                static if $up$ then
                    set thistype.INCREASING_SPELLS_ID[$index$] = 'AiD$index$'
                else
                    set thistype.DECREASING_SPELLS_ID[$index$] = 'AdD$index$'
                endif
                ...
                $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                    ...
                    //! i if $up$ then
                        //! i createobject("AItg", "AiD$index$")

                        //! i set("anam", "Increase Damage Bonus")
                        //! i setl("Iatt", 1, math.pow(2, $index$))
                    //! i else
                        //! i createobject("AItg", "AdD$index$")

                        //! i set("anam", "Decrease Damage Bonus")
                        //! i setl("Iatt", 1, -math.pow(2, $index$))
                    //! i end
                ...
                static if $up$ then
                    call InitAbility('AiD$index$')
                else
                    call InitAbility('AdD$index$')
                endif
            //! endtextmacro
            ...
            static method Init takes nothing returns nothing
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "0")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "1")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "2")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "3")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "4")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "5")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "false", "6")

                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "0")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "1")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "2")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "3")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "4")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "5")
                //! runtextmacro BJUnit_Damage_Bonus_CreateObjects("/", "true", "6")
            endmethod
        endstruct
    endscope

    //! runtextmacro Struct("Damage")
        static constant integer DECREASING_ITEMS_MAX = 7
        static item array DECREASING_ITEMS
        static constant integer INCREASING_ITEMS_MAX = 7
        static item array INCREASING_ITEMS
        static integer array PACKETS

        //! runtextmacro LinkToStaticStruct("Damage", "Bonus")

        //! textmacro BJUnit_Damage_CreateObjects takes doExternal, up, index
            set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i if $up$ then
                    //! i createobject("AIaa", "Aid$index$")

                    //! i set("anam", "Increase Damage")
                    //! i setl("Iaa1", 1, math.pow(2, $index$))
                //! i else
                    //! i createobject("AIaa", "Add$index$")

                    //! i set("anam", "Decrease Damage")
                    //! i setl("Iaa1", 1, -math.pow(2, $index$))
                //! i end
                ...
                //! i if $up$ then
                    //! i createobject("manh", "Iid$index$")

                    //! i set("iabi", "Aid$index$")
                    //! i set("unam", "Increase Damage $index$")
                //! i else
                    //! i createobject("manh", "Idd$index$")

                    //! i set("iabi", "Add$index$")
                    //! i set("unam", "Decrease Damage $index$")
                //! i end

                //! i set("iarm", "")
                //! i set("icid", "")
                //! i set("icla", "Miscellaneous")
                //! i set("iclb", 0)
                //! i set("iclg", 0)
                //! i set("iclr", 0)
                //! i set("ides", "($index$)")
            ...
            static if $up$ then
                set thistype.INCREASING_ITEMS[$index$] = CreateItem('Iid$index$', 0., 0.)
                call InitAbility('Aid$index$')
            else
                set thistype.DECREASING_ITEMS[$index$] = CreateItem('Idd$index$', 0., 0.)
                call InitAbility('Add$index$')
            endif
        //! endtextmacro
        ...
        static method Init takes nothing returns nothing
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "0")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "1")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "2")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "3")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "4")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "5")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "6")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "false", "7")

            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "0")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "1")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "2")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "3")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "4")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "5")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "6")
            //! runtextmacro BJUnit_Damage_CreateObjects("/", "true", "7")
...
if (whichBuff==UNIT.Eclipse.DUMMY_BUFF) then
    call BJDebugMsg("subtract "+I2S(Unit(this).Data.Integer.Get(KEY_ARRAY_DETAIL + whichBuff)))
endif
...
call BJDebugMsg("steal")
            loop
                ...
                set iteration = iteration - 1
            endloop
call BJDebugMsg("stealB "+I2S(count))
            loop
                exitwhen (count < ARRAY_MIN)
call BJDebugMsg("stealC "+temp[count].GetName()+" with "+R2S(duration[count]))
    ...
    //! runtextmacro Folder("Attack")
        //! runtextmacro Folder("Events")
            ...
            //! runtextmacro Struct("Ground")
                ...
                //! runtextmacro DummyUnit_CreateSimpleType("/", "dGrA", "Ground Attack", "DUMMY_UNIT_ID", "")
        ...
        //! runtextmacro Folder("Speed")
            //! runtextmacro Struct("BonusA")
                /*//! textmacro Unit_Attack_Speed_Bonus_CreateObjects takes doExternal, up, index
                    static if $up$ then
                        set INCREASING_SPELLS_ID[$index$] = 'AiR$index$'
                    else
                        set DECREASING_SPELLS_ID[$index$] = 'AdR$index$'
                    endif
                    set PACKETS[$index$] = Math.PowerOf2I($index$)
                ...
                static method Init takes nothing returns nothing
                    /*//! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "0")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "1")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "2")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "3")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "4")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "5")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "6")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "7")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "8")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "false", "9")

                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "0")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "1")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "2")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "3")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "4")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "5")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "6")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "7")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "8")
                    //! runtextmacro Unit_Attack_Speed_Bonus_CreateObjects("/", "true", "9")*/
                endmethod
            endstruct
        endscope
    ...
    //! runtextmacro Struct("Attack")
        ...
        //! textmacro Attack_CreateObjects takes doExternal, iconSpellRaw
            static constant integer ICON_SPELL_ID = '$iconSpellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i createobject("Agyb", "$iconSpellRaw$")

                //! i set("aart", "ReplaceableTextures\\CommandButtons\\BTNDisabledAttack.blp")
                //! i set("abpx", 3)
                //! i set("abpy", 0)
                //! i set("anam", "Attack Disabled")
                //! i set("ansf", "(Icon)")
                //! i set("arac", "other")
                //! i set("areq", "")
                //! i setl("atp1", 1, "Attack")
                //! i setl("aub1", 1, "Your attack is disabled due to an effect.")
            $doExternal$//! endexternalblock
        //! endtextmacro

        //! runtextmacro Attack_CreateObjects("/", "ADAI")
        ...
        static method Init takes nothing returns nothing
            ...
            set thistype.NONE_BUFF = Buff.CreateHidden(thistype.NAME)
            ...
            set thistype.NORMAL_BUFF = Buff.CreateHidden(thistype.NAME)
    ...
    //! runtextmacro Struct("Display")
        //! textmacro Display_CreateObjects takes doExternal, spellRaw
            static constant integer SPELL_ID = '$spellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i createobject("AImh", "$spellRaw$")

                //! i set("aart", "")
                //! i set("acap", "")
                //! i set("acat", "")
                //! i set("aite", "\0")
                //! i set("anam", "Update Unit Display")
                //! i set("ansf", "")
                //! i setl("Ilif", 1, 0)
            $doExternal$//! endexternalblock
        //! endtextmacro

        //! runtextmacro Display_CreateObjects("/", "AUUD")

        method Update takes nothing returns nothing
            call Unit(this).Abilities.AddBySelf(thistype.SPELL_ID)
            call Unit(this).Abilities.RemoveBySelf(thistype.SPELL_ID)
        endmethod

        static method Init takes nothing returns nothing
            call InitAbility(thistype.SPELL_ID)
        endmethod
    endstruct
    ...
    //! runtextmacro Struct("EvasionChance")
        ...
        //! textmacro EvasionChance_CreateObjects takes doExternal, spellRaw
            static constant integer SPELL_ID = '$spellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i createobject("ACev", "$spellRaw$")

                //! i set("aart", "")
                //! i set("abpx", 0)
                //! i set("abpy", 0)
                //! i set("alev", 101)
                //! i set("anam", "Modify Evasion Chance")
                //! i set("ansf", "")
                //! i set("arac", "other")
                //! i setl("atp1", 1, "")
                //! i setl("aub1", 1, "")
                ...
                //! i for i = 1, 101, 1 do
                    //! i setl("Eev1", tostring(i), i / 100. - 0.01)
                //! i end
            $doExternal$//! endexternalblock
        //! endtextmacro

        //! runtextmacro EvasionChance_CreateObjects("/", "AmEC")
        ...
        method Set takes real chance returns nothing
            ...
            call SetUnitAbilityLevel(Unit(this).self, thistype.SPELL_ID, 1 + Real.ToInt(chance * 100))
        endmethod
    ...
    //! textmacro Unit_StateWithTemporaryAbilities_CreateVariables takes decreasingSpellRaw, increasingSpellRaw
        static constant integer DECREASING_SPELL_ID = '$decreasingSpellRaw$'
        static constant integer INCREASING_SPELL_ID = '$increasingSpellRaw$'
        static integer array PACKETS
    //! endtextmacro

    //! textmacro Unit_StateWithTemporaryAbilities_Init takes spellMax
        local integer iteration = $spellMax$ - 2

        loop
            set thistype.PACKETS[iteration] = Math.PowerOf2I(iteration)

            set iteration = iteration - 1
            exitwhen (iteration < ARRAY_MIN)
        endloop
        call InitAbility(thistype.DECREASING_SPELL_ID)
        call InitAbility(thistype.INCREASING_SPELL_ID)
    //! endtextmacro

    //! textmacro Unit_CreateStateWithTemporaryAbilities takes decreasingMax, increasingMax, factor
        static constant integer DECREASING_SPELLS_MAX = $decreasingMax$ - 2
        static constant integer INCREASING_SPELLS_MAX = $increasingMax$ - 2
    ...
    //! runtextmacro Struct("Invulnerability")
        ...
        static method Init takes nothing returns nothing
            ...
            set thistype.NONE_BUFF = Buff.CreateHidden(thistype.NAME)
            //! runtextmacro Buff_Create("/", "NORMAL_BUFF", "Ivu", "Invulnerable", "1", "true", "ReplaceableTextures\\CommandButtons\\BTNInvulnerable.blp", "This unit is immune to all kind of damages.")
            ...
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Gain.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_BuffGain))
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Lose.DUMMY_EVENT_TYPE, EventPriority.SPELLS, function thistype.Event_BuffLose))
            call currentBuff.TargetEffects.Add("Abilities\\Spells\\Human\\DivineShield\\DivineShieldTarget.mdl", AttachPoint.ORIGIN, EffectLevel.LOW)
    ...
    //! runtextmacro Folder("MagicImmunity")
        //! runtextmacro Struct("SpellShield")
            ...
            static method Init takes nothing returns nothing
                ...
                //! runtextmacro Buff_Create("/", "NORMAL_BUFF", "MSP", "Spell Shield", "1", "true", "ReplaceableTextures\\CommandButtons\\BTNRejuvenation.blp", "Deflects a negative spell.")
                ...
                call currentBuff.TargetEffects.Add("Abilities\\Spells\\Items\\StaffOfSanctuary\\Staff_Sanctuary_Target.mdl", AttachPoint.CHEST, EffectLevel.LOW)
            endmethod
        endstruct
    endscope
    ...
    //! runtextmacro Struct("MagicImmunity")
        ...
        static method Init takes nothing returns nothing
            ...
            set thistype.NONE_BUFF = Buff.CreateHidden(thistype.NAME)
            //! runtextmacro Buff_Create("/", "NORMAL_BUFF", "MaI", "Magic immune", "1", "true", "ReplaceableTextures\\CommandButtons\\BTNAntiMagicShell.blp", "This unit is protected from most negative magic.")
            ...
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Gain.DUMMY_EVENT_TYPE, EventPriority.HEADER, function thistype.Event_BuffGain))
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Lose.DUMMY_EVENT_TYPE, EventPriority.HEADER, function thistype.Event_BuffLose))
            call currentBuff.TargetEffects.Add("Abilities\\Spells\\Undead\\AntiMagicShell\\AntiMagicShell.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
    ...
    //! runtextmacro Struct("Cold")
        ...
        static method Init takes nothing returns nothing
            //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "Col", "Cold", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNFrost.blp", "This unit is stiff. It receives more damage when being under 25% of life and explodes upon death.")
    ...
    //! runtextmacro Folder("Invisibility")
        //! runtextmacro Struct("Reveal")
            ...
            static method Event_BuffLose takes nothing returns nothing
                ...
                if (value == 0) then
                    if (parent.Invisibility.Is()) then
                        call parent.Abilities.AddBySelf(UNIT.Invisibility.SPELL_ID)
                    endif
                endif
            endmethod
            ...
            static method Event_BuffGain takes nothing returns nothing
                ...
                if (value == 1) then
                    if (parent.Invisibility.Is()) then
                        call parent.Abilities.RemoveBySelf(UNIT.Invisibility.SPELL_ID)
    ...
    //! runtextmacro Struct("Invisibility")
        ...
        //! textmacro Invisibility_CreateObjects takes doExternal
            static constant integer SPELL_ID = 'Apiv'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i makechange(current, "Gho1", 1, 0)
            $doExternal$//! endexternalblock
        //! endtextmacro

        //! runtextmacro Invisibility_CreateObjects("/")
        ...
        static method Event_BuffLose takes nothing returns nothing
            ...
            if (value == 0) then
                ...
                call parent.Abilities.RemoveBySelf(thistype.SPELL_ID)
        ...
        static method Event_BuffGain takes nothing returns nothing
            ...
            if (value == 1) then
                if (this.Reveal.Is() == false) then
                    ...
                    call parent.Abilities.AddBySelf(thistype.SPELL_ID)
                endif
            endif
        endmethod
        ...
        static method Init takes nothing returns nothing
            ...
            set thistype.TIMED_BUFF = Buff.CreateHidden(thistype.NAME)
    ...
    //! runtextmacro Struct("Ghost")
        ...
        //! textmacro Ghost_CreateObjects takes doExternal, spellRaw
            static constant integer SPELL_ID = '$spellRaw$'
        ...
        //! runtextmacro Ghost_CreateObjects("/", "AEth")
    ...
    //! runtextmacro Struct("MaxLife")
        ...
        //! textmacro MaxLife_CreateObjects takes doExternal, spellRaw, spellMax, up
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                //! i function set(field, value)
                    //! i makechange(current, field, value)
                //! i end
                ...
                //! i if $up$ then
                    //! i createobject("AIlf", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Increase Max Life")
                    //! i setl("Ilif", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Ilif", i + 2, -math.pow(2, i))
                    //! i end
                //! i else
                    //! i createobject("AIlf", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Decrease Max Life")
                    //! i setl("Ilif", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Ilif", i + 2, math.pow(2, i))
                    //! i end
        ...
        //! runtextmacro MaxLife_CreateObjects("/", "AdLf", "12", "false")
        //! runtextmacro MaxLife_CreateObjects("/", "AiLf", "12", "true")
        //! runtextmacro Unit_StateWithTemporaryAbilities_CreateVariables("AdLf", "AiLf")
        ...
        //! runtextmacro Unit_CreateStateWithTemporaryAbilities("12", "12", "* this.Relative.Get() + this.Bonus.Get()")
        ...
        static method Init takes nothing returns nothing
            //! runtextmacro Unit_StateWithTemporaryAbilities_Init("12")
    ...
    //! runtextmacro Struct("Life")
        ...
        static constant real IMMORTAL = LIMIT_OF_DEATH + 1.
    ...
    //! runtextmacro Struct("MaxMana")
        ...
        //! textmacro MaxMana_CreateObjects takes doExternal, spellRaw, spellMax, up
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                //! i function set(field, value)
                    //! i makechange(current, field, value)
                //! i end
                ...
                //! i if $up$ then
                    //! i createobject("AImv", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Increase Max Mana")
                    //! i setl("Iman", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Iman", i + 2, -math.pow(2, i))
                    //! i end
                //! i else
                    //! i createobject("AImv", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Decrease Max Mana")
                    //! i setl("Iman", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Iman", i + 2, math.pow(2, i))
                    //! i end
        ...
        //! runtextmacro MaxMana_CreateObjects("/", "AdMn", "12", "false")
        //! runtextmacro MaxMana_CreateObjects("/", "AiMn", "12", "true")
        //! runtextmacro Unit_StateWithTemporaryAbilities_CreateVariables("AdMn", "AiMn")
    ...
    //! runtextmacro Folder("Movement")
        ...
        //! runtextmacro Folder("Speed")
            //! runtextmacro Struct("BonusA")
                ...
                //! textmacro Movement_Speed_Bonus_CreateObjects takes doExternal, spellRaw, storageSpellRaw
                    static constant integer SPELL_ID = '$spellRaw$'
                    static constant integer STORAGE_SPELL_ID = '$storageSpellRaw$'
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i createobject("AIms", "$spellRaw$")

                        //! i set("aart", "")
                        //! i set("alev", 3)
                        //! i set("anam", "Modify Speed")
                        //! i set("aite", "\0")
                        //! i setl("Imvb", 1, 0)
                        //! i setl("Imvb", 2, -1)
                        //! i setl("Imvb", 3, 1)
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i createobject("Aspb", "$storageSpellRaw$")

                        //! i set("aart", "")
                        //! i set("aite", "\0")
                        //! i set("anam", "Ability Storage")
                        //! i setl("spb1", 1, "$spellRaw$")
                        //! i setl("spb2", 1, "\0")
                        //! i setl("spb3", 1, 0)
                        //! i setl("spb4", 1, 11)
                    $doExternal$//! endexternalblock
                ...
                //! runtextmacro Movement_Speed_Bonus_CreateObjects("/", "AmSp", "AmSx")
                ...
                method Set takes real value returns nothing
                    ...
                    call Unit(this).Abilities.SetLevelBySelf(thistype.SPELL_ID, abilityLevel)
    ...
    //! runtextmacro Struct("Movement")
        static Buff DUMMY_BUFF
        static constant integer SPELL_ID = 'Amov'
    ...
    //! runtextmacro Struct("Eclipse")
        ...
        static method Init takes nothing returns nothing
            //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "Ecl", "Eclipse", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNSoulGem.blp", "This unit is caught in an eclipse. Its spell power is decreased by 50%, armor by 25% and it does not regenerate mana.")
    ...
    //! runtextmacro Struct("Revival")
        ...
        //! textmacro Revival_CreateObjects takes doExternal, spellRaw
            static constant integer SPELL_ID = '$spellRaw$'
        ...
        //! runtextmacro Revival_CreateObjects("/", "ARev")
        ...
        static method Init takes nothing returns nothing
            ...
            call DummyUnit.WORLD_CASTER.Abilities.AddBySelf(thistype.SPELL_ID)
    ...
    //! runtextmacro Struct("Silence")
        ...
        //! textmacro Silence_CreateObjects takes doExternal, buffRaw, spellRaw
            static constant integer BUFF_ID = '$buffRaw$'
            static constant integer SPELL_ID = '$spellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i createobject("BNdo", "$buffRaw$")

                //! i set("fart", "ReplaceableTextures\\CommandButtons\\BTNSilence.blp")
                //! i set("frac", "human")
                //! i set("ftat", "")
                //! i set("ftip", "Silenced")
                //! i set("fube", "This unit has lost its voice; it cannot cast any spells.")

                //! i setobjecttype("abilities")

                //! i createobject("ANso", "$spellRaw$")

                //! i setl("abuf", 1, "$buffRaw$")
                //! i set("abpy", 0)
                //! i setl("acdn", 1, 0)
                //! i setl("adur", 1, 0)
                //! i setl("ahdu", 1, 0)
                ...
                //! i set("arac", "other")
                //! i setl("aran", 1, 99999)
                //! i setl("atar", 1, "ground,enemies,friend,structure,air,neutral,invulnerable,vulnerable,ward")
                //! i setl("atp1", 1, "")
                //! i setl("aub1", 1, "")
                //! i setl("Nso1", 1, 0)
                //! i setl("Nso2", 1, 99999)
        ...
        //! runtextmacro Silence_CreateObjects("/", "BSil", "ASil")
        ...
        static method Event_BuffLose takes nothing returns nothing
            ...
            set this.value = value
            if (value == 0) then
                call Unit(this).Buffs.RemoveBySelf(thistype.BUFF_ID)
            endif
        endmethod
        ...
        static method Init takes nothing returns nothing
            call InitBuff(thistype.BUFF_ID)
            call InitAbility(thistype.SPELL_ID)
    ...
    //! runtextmacro Struct("Sleep")
        ...
        //! textmacro Unit_Sleep_CreateObjects takes doExternal
            static integer SLEEP_BUFF_ID = 'BUsl'
            static integer SLEEP_INVU_BUFF_ID = 'BUsp'
            static integer SLEEP_SPELL_ID = 'ACsl'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i modifyobject("ACsl", "ACsl")

                //! i setl("acdn", 1, 0)
                //! i setl("adur", 1, 0)
                //! i setl("ahdu", 1, 0)
                //! i setl("amcs", 1, 0)
                //! i set("anam", "Unit Sleep")
                //! i setl("aran", 1, 99999)
                //! i setl("atar", 1, "enemy,friend,invulnerable,neutral,vulnerable")
                //! i setl("Usl1", 1, 0)

                //! i setobjecttype("buffs")

                //! i modifyobject("BUsl", "BUsl")
        ...
        //! runtextmacro Unit_Sleep_CreateObjects("/")
        ...
        static method Init takes nothing returns nothing
            ...
            //! runtextmacro Buff_Create("/", "DUMMY_BUFF", "ELB", "Sleep", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNSleep.blp", "zzZ")
    ...
    //! runtextmacro Folder("Stun")
        //! runtextmacro Struct("Cancel")
            ...
            method Ending takes Timer delayTimer, Unit parent returns nothing
                ...
                call parent.Data.Integer.Remove(KEY)
                call parent.Event.Remove(DEATH_EVENT)
                call Unit(parent).Buffs.RemoveBySelf(UNIT.Stun.BUFF_ID)
            endmethod
    ...
    //! runtextmacro Struct("Stun")
        ...
        //! textmacro Unit_Stun_CreateObjects takes doExternal, buffRaw, spellRaw
            static constant integer BUFF_ID = '$buffRaw$'
            static constant integer SPELL_ID = '$spellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                //! i set("fta0", "")
                //! i set("ftip", "Stunned")
                //! i set("fube", "This unit is stunned and therefore cannot do any actions.")

                //! i setobjecttype("abilities")

                //! i createobject("AHtb", "$spellRaw$")
        ...
        //! runtextmacro Unit_Stun_CreateObjects("/", "BStn", "AStn")
        ...
        static method Init takes nothing returns nothing
            ...
            set thistype.NONE_BUFF = Buff.CreateHidden(thistype.NAME + " (none)")
            set thistype.NORMAL_BUFF = Buff.CreateHidden(thistype.NAME + " (normal)")
            ///! runtextmacro Buff_Create("/", "NORMAL_BUFF", "Stu", "Stunned", "1", "false", "ReplaceableTextures\\CommandButtons\\BTNStun.blp", "This unit is stunned.")
            ...
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Gain.DUMMY_EVENT_TYPE, EventPriority.HEADER, function thistype.Event_BuffGain))
            call currentBuff.Event.Add(Event.Create(UNIT.Buffs.Events.Lose.DUMMY_EVENT_TYPE, EventPriority.HEADER, function thistype.Event_BuffLose))
            call currentBuff.TargetEffects.Add("Abilities\\Spells\\Human\\Thunderclap\\ThunderclapTarget.mdl", AttachPoint.OVERHEAD, EffectLevel.LOW)
    ...
    //! runtextmacro Struct("Transport")
        static Buff DUMMY_BUFF
        //! runtextmacro DummyUnit_CreateSimpleType("/", "dTra", "Unit Transporter", "DUMMY_UNIT_ID", "")
        //add 1 hp to transporter

        DummyUnit dummyUnit

        //! textmacro Transport_CreateObjects takes doExternal, cargoSpellRaw
            static constant integer CARGO_SPELL_ID = '$cargoSpellRaw$'
            ...
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                ...
                /*//! i createobject("Sch2", "$cargoSpellRaw$")

                //! i setl("aare", 1, 0)
                //! i setl("adur", 1, 0)
                //! i set("aefs", "")
                //! i setl("ahdu", 1, 0)
                //! i set("anam", "Transport Cargo")
                //! i set("ansf", "")
                //! i set("arac", "other")
                //! i setl("aran", 1, 0)
                //! i setl("atar", 1, "invulnerable,vulnerable")
                //! i setl("Car1", 1, 1)*/

                //! i createobject("Advc", "$cargoSpellRaw$")
                ...
                //! i modifyobject("Aloa", "Aloa")

                //! i setl("aare", 1, 0)
                //! i set("aart", "")
                //! i set("abpy", 0)
                //! i set("ahky", "")
                //! i set("anam", "Transport Load In")
                //! i set("ansf", "")
                //! i setl("aran", 1, 0)
                //! i setl("atar", 1, "enemy,friend,invulnerable,neutral,vulnerable")
                //! i setl("atp1", 1, "")
        ...
        //! runtextmacro Transport_CreateObjects("/", "ATra")
    ...
    //! runtextmacro Folder("Position")
        ...
        //! runtextmacro Struct("Z")
            static constant integer SPELL_ID = 'Amrf'
    ...
    //! runtextmacro Struct("SightRange")
        //! textmacro SightRange_CreateObjects takes doExternal, spellRaw, spellMax, up
            $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                //! i function set(field, value)
                    //! i makechange(current, field, value)
                //! i end
                ...
                //! i if $up$ then
                    //! i createobject("AIsi", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Increase Sight Range")
                    //! i setl("Isib", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Isib", i + 2, -math.pow(2, i))
                    //! i end
                //! i else
                    //! i createobject("AIsi", "$spellRaw$")

                    //! i set("alev", $spellMax$)
                    //! i set("anam", "Decrease Sight Range")
                    //! i setl("Isib", 1, 0)
                    //! i for i = 0, $spellMax$, 1 do
                        //! i setl("Isib", i + 2, math.pow(2, i))
                    //! i end
        ...
        //! runtextmacro SightRange_CreateObjects("/", "AdSR", "12", "false")
        //! runtextmacro SightRange_CreateObjects("/", "AiSR", "12", "true")
        //! runtextmacro Unit_StateWithTemporaryAbilities_CreateVariables("AdSR", "AiSR")

        //! runtextmacro Unit_CreateStateWithTemporaryAbilities("12", "12", "")
    ...
    ///! runtextmacro Folder("Hero")
        ...
        //! textmacro CreateHeroAttribute takes decreasingMax, increasingMax, name
            static integer array DECREASING_SPELLS_ID
            static constant integer DECREASING_SPELLS_MAX = $decreasingMax$
            static integer array INCREASING_SPELLS_ID
            static constant integer INCREASING_SPELLS_MAX = $increasingMax$
        ...
        //! runtextmacro Folder("Agility")
            //! runtextmacro Struct("Bonus")
                //! runtextmacro CreateHeroAttribute("6", "6", "Agility")

                //! textmacro Agility_Bonus_CreateObjects takes doExternal, up, index
                    static if $up$ then
                        set thistype.INCREASING_SPELLS_ID[$index$] = 'AiG$index$'
                    else
                        set thistype.DECREASING_SPELLS_ID[$index$] = 'AdG$index$'
                    endif
                    set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i if $up$ then
                            //! i createobject("Aamk", "AiG$index$")

                            //! i set("anam", "Increase Agility")
                            //! i setl("Iagi", 1, math.pow(2, $index$))
                            //! i setl("Iint", 1, 0)
                            //! i setl("Istr", 1, 0)
                        //! i else
                            //! i createobject("Aamk", "AdG$index$")

                            //! i set("anam", "Decrease Agility")
                            //! i setl("Iagi", 1, -math.pow(2, $index$))
                            //! i setl("Iint", 1, 0)
                            //! i setl("Istr", 1, 0)
                        //! i end
                    ...
                    static if $up$ then
                        call InitAbility('AiG$index$')
                    else
                        call InitAbility('AdG$index$')
                    endif
                //! endtextmacro

                static method Init takes nothing returns nothing
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "0")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "1")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "2")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "3")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "4")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "5")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "false", "6")

                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "0")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "1")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "2")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "3")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "4")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "5")
                    //! runtextmacro Agility_Bonus_CreateObjects("/", "true", "6")
                endmethod
            endstruct
        endscope
        ...
        //! runtextmacro Folder("Intelligence")
            //! runtextmacro Struct("Bonus")
                //! runtextmacro CreateHeroAttribute("6", "6", "Intelligence")

                //! textmacro Intelligence_Bonus_CreateObjects takes doExternal, up, index
                    static if $up$ then
                        set thistype.INCREASING_SPELLS_ID[$index$] = 'AiI$index$'
                    else
                        set thistype.DECREASING_SPELLS_ID[$index$] = 'AdI$index$'
                    endif
                    set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i if $up$ then
                            //! i createobject("Aamk", "AiI$index$")

                            //! i set("anam", "Increase Intelligence")
                            //! i setl("Iagi", 1, 0)
                            //! i setl("Iint", 1, math.pow(2, $index$))
                            //! i setl("Istr", 1, 0)
                        //! i else
                            //! i createobject("Aamk", "AdI$index$")

                            //! i set("anam", "Decrease Intelligence")
                            //! i setl("Iagi", 1, 0)
                            //! i setl("Iint", 1, -math.pow(2, $index$))
                            //! i setl("Istr", 1, 0)
                        //! i end
                    ...
                    static if $up$ then
                        call InitAbility('AiI$index$')
                    else
                        call InitAbility('AdI$index$')
                    endif
                //! endtextmacro

                static method Init takes nothing returns nothing
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "0")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "1")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "2")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "3")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "4")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "5")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "false", "6")

                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "0")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "1")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "2")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "3")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "4")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "5")
                    //! runtextmacro Intelligence_Bonus_CreateObjects("/", "true", "6")
                endmethod
            endstruct
        endscope
        ...
        //! runtextmacro Folder("Strength")
            //! runtextmacro Struct("Bonus")
                //! runtextmacro CreateHeroAttribute("6", "6", "Strength")

                //! textmacro Strength_Bonus_CreateObjects takes doExternal, up, index
                    static if $up$ then
                        set thistype.INCREASING_SPELLS_ID[$index$] = 'AiP$index$'
                    else
                        set thistype.DECREASING_SPELLS_ID[$index$] = 'AdP$index$'
                    endif
                    set thistype.PACKETS[$index$] = Math.PowerOf2I($index$)
                    ...
                    $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
                        ...
                        //! i if $up$ then
                            //! i createobject("Aamk", "AiP$index$")

                            //! i set("anam", "Increase Strength")
                            //! i setl("Iagi", 1, 0)
                            //! i setl("Iint", 1, 0)
                            //! i setl("Istr", 1, math.pow(2, $index$))
                        //! i else
                            //! i createobject("Aamk", "AdP$index$")

                            //! i set("anam", "Decrease Strength")
                            //! i setl("Iagi", 1, 0)
                            //! i setl("Iint", 1, 0)
                            //! i setl("Istr", 1, -math.pow(2, $index$))
                        //! i end
                    ...
                    static if $up$ then
                        call InitAbility('AiP$index$')
                    else
                        call InitAbility('AdP$index$')
                    endif
                //! endtextmacro

                static method Init takes nothing returns nothing
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "0")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "1")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "2")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "3")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "4")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "5")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "false", "6")

                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "0")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "1")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "2")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "3")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "4")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "5")
                    //! runtextmacro Strength_Bonus_CreateObjects("/", "true", "6")
                endmethod
            endstruct
        endscope
...
//! runtextmacro BaseStruct("Unit", "UNIT")
    ...
    static integer HERO_INVENTORY_SPELL_ID = 'AInv'
    //! runtextmacro GetKey("KEY")
