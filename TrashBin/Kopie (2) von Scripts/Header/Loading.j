//! runtextmacro BaseStruct("Loading", "LOADING")
    ...
    static constant real PERCENT_ADD = 100. / 28
    ...
    static method Start takes nothing returns nothing
        ...
        set thistype.DUMMY_UNIT = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'u004', 0., 0., 270.)
...
call EnableWeatherEffect(AddWeatherEffect(GetWorldBounds(), 'SNbs'), true)
