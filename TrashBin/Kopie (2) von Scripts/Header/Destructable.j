...
//! runtextmacro BaseStruct("DestructableType", "DESTRUCTABLE_TYPE")
    ...
    static method Init takes nothing returns nothing
        set thistype.EXPLOSIVE = thistype.Create('B00A')
        set thistype.KEG = thistype.Create('B00B')
    endmethod
endstruct
...
//! runtextmacro BaseStruct("Destructable", "DESTRUCTABLE")
    ...
    //! textmacro DummyDestructable_CreateSimpleType takes doExternal, destructableRaw, objectName, varName, modelPath, walkable
        static constant integer $varName$ = '$destructableRaw$'
        ...
        $doExternal$//! externalblock extension=lua ObjectMerger $FILENAME$
            ...
            //! i createobject("OTip", "$destructableRaw$")
            //! i set("barm", "")
            //! i set("bcpr", "\0")
            //! i set("bfil", "$modelPath$")
            //! i set("bgsc", "0")
            //! i set("bnam", "$objectName$")
            //! i set("bonc", "\0")
            //! i set("bonw", "\0")
            //! i set("bptx", "")
            //! i set("bsel", "0")
