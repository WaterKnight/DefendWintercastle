...
//! textmacro Create1DState takes name, type, typeName
    ////! runtextmacroGetKeyArray("$name$_KEY_ARRAY_DETAIL")
        static key $name$_KEY_ARRAY_DETAIL_BASE

        static constant integer $name$_KEY_ARRAY_DETAIL = Math.Integer.MIN + Memory.IntegerKeys.Table.OFFSET + $name$_KEY_ARRAY_DETAIL_BASE * Memory.IntegerKeys.Table.SIZE
    ////! runtextmacroGetKeyArray("$name$_KEY_ARRAY_DETAIL")
